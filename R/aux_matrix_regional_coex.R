...
#' @param round.digits Integer. The number of decimal places to round time values
...
#'
#' @return A list of binary co-occurrence matrices, with one matrix per time slice.
#'     Each matrix has the following properties:
#'     \itemize{
#'       \item Dimensions: n × n, where n = total number of species in \code{df.TS.TE}
