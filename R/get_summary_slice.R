df.TS.TE_original <- read.csv(here::here("data_faurby", "data_faurby.csv"), sep = ";")
df.TS.TE <- read.csv(here::here("data_faurby", "data_faurby.csv"), sep = ";")
...
df.TS.TE <- 
  df.TS.TE |> 
  dplyr::mutate(Minimum_Age = as.numeric(Minimum_Age), Maximum_Age = as.numeric(Maximum_Age))
