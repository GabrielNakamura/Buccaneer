...
This output contain two data frames, one with all individual
coexistences per species in all time slices, and another containing the
mean species coexistence considering all time slices
...
We can plot the results of all time mean species coexistence for three
species
